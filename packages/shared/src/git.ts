...
// Canonical form is `worktree/<8 hex>`. Older clients generated `t3code/<8 hex>`
// or `t3code/<uuid>`, so the matcher keeps accepting those exact shapes. This lets
// existing threads finish their semantic rename while new workspace names remain
// product-neutral and easy to recognize.
