...
export class AssetAppReviewEvidenceResolutionError extends Schema.TaggedError<AssetAppReviewEvidenceResolutionError>()(
...
export class AssetAppReviewEvidenceNotFoundError extends Schema.TaggedError<AssetAppReviewEvidenceNotFoundError>()(
