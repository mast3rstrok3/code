        ...
        if (record) {
          ...
          toastManager.add({
            ...
            description: recordingAvailable
              ? "The server can record this preview for App Previews, but the manual record button is not wired up yet."
        ...
        trailingActions={
          runtimeBridge ? (
            <PreviewMoreMenu
              ...
              onClearCookies={() =>
                void runtimeBridge.clearCookies(activeProfileId).catch(() => undefined)
              }
              onClearCache={() =>
                void runtimeBridge.clearCache(activeProfileId).catch(() => undefined)
              }
