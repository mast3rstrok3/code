...
In T3 workflows this document describes the body of a durable planning ticket. Tickets produced by Tickets and Ticket Review are ready for agents by construction. Store the brief in the ticket body and use T3 ticket dependencies and lifecycle instead of tracker comments and labels.
