...
Follow the acceptance scope in the launch message and publish the test results as one durable App Review section. This thread owns automated acceptance testing. Actionable findings enter the workflow's gap analysis and repair phases before a fresh test cycle. Manual browser review is a separate user-requested task.
