...
import { StaleTurnReconcilerLive } from "./orchestration/Layers/StaleTurnReconciler.ts";
...
// Reuse the receiver so the desktop telemetry file descriptor has one reader.
...
const ReactorLayerLive = Layer.empty.pipe(
  ...
  Layer.provideMerge(AppReviewWorkflowReactorLive.pipe(Layer.provide(ProcessRunner.layer))),
