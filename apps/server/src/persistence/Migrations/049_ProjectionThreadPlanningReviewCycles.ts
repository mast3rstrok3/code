...
export default Effect.gen(function* () {
  ...
  yield* sql`
    CREATE TABLE IF NOT EXISTS projection_thread_planning_review_cycles (
      ...
      failing_planning_ticket_ids_json TEXT NOT NULL,
      dependency_feedback_json TEXT NOT NULL,
      per_ticket_feedback_json TEXT NOT NULL,
  ...
  yield* sql`
    CREATE INDEX IF NOT EXISTS idx_projection_thread_planning_review_cycles_spec
    ON projection_thread_planning_review_cycles(spec_id, cycle_number)
  `;
});
