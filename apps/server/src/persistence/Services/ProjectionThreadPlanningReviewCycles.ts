import {
  ...
  OrchestrationPlanningReviewMode,
...
export const ProjectionThreadPlanningReviewCycle = Schema.Struct({
  ...
  editedPlanningTicketIds: Schema.Array(OrchestrationPlanningTicketId),
...
export function projectionReviewCycleFromContract(
  ...
  return {
    ...
    targetPlanningTicketIds: reviewCycle.targetPlanningTicketIds,
    editedPlanningTicketIds: reviewCycle.editedPlanningTicketIds,
