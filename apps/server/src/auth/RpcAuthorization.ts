...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.appStackStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.appStackList]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.appStackDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.appStackListPods]: AuthOrchestrationReadScope,
  [WS_METHODS.appStackGetPodLogs]: AuthOrchestrationReadScope,
  [WS_METHODS.appStackGetStackPodLogs]: AuthOrchestrationReadScope,
  [WS_METHODS.appStackGetAllStackPodLogs]: AuthOrchestrationReadScope,
